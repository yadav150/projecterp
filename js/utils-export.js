 ...
 * @param {Array} required - array of required column names
 * @returns {Object} - { valid: boolean, missing: Array }
 */
export function validateCSVHeaders(headers, required) {
 ...
 */
export function getStudentCSVTemplate() {
  const headers = ['name', 'class', 'section', 'gender', 'dob', 'fatherName', 'motherName', 'phone', 'email', 'address', 'admissionDate'];
  return headers.join(',') + '\n';
}

/**
 * Get sample CSV template for teachers
 * @returns {string} CSV template string
 */
export function getTeacherCSVTemplate() {
  const headers = ['name', 'gender', 'qualification', 'experience', 'department', 'designation', 'salary', 'phone', 'email', 'address', 'joiningDate'];
  return headers.join(',') + '\n';
}
