...
// Apply pending routes from any router extension
...
function render() {
  try {
    ...
    page.innerHTML = `<div class="state"><div class="state-title">Error loading page</div><div class="state-sub">${e.message}</div></div>`;
  }
}
